...
import { Eye, EyeOff, Lock, Mail, User, Hash, ShipWheel } from "lucide-react";
...
function SignupPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // If backend returns tokens + user, log them in immediately
            ...
            setForm({ email: "", name: "", password: "", customerNo: "" });
            ...
            <div className="w-full max-w-md">
                <div className="bg-white/95 backdrop-blur-xl shadow-2xl p-8 border border-white/60">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="font-semibold text-gray-900">Create your account</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label className="text-sm text-gray-600 mb-1 block">Customer number</label>
                            <div className="relative">
                                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                                    <Hash size={18} />
                                </div>
